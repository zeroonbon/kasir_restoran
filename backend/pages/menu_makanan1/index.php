...
.menu-footer {
    ...
    align-items: flex-end;   /* posisi bawah */
    height: 70px;            /* tinggi footer tetap agar tombol rata bawah */
}
.menu-footer .btn {
    width: 100%;
    max-width: 220px; /* biar nggak terlalu panjang */
    border-radius: 50px;
}
...
<a href="../../pages/menu_makanan1/pesan_makanan.php?id=<?= $item['id_masakan'] ?>" 
   ...
   Pesan Makanan
                    ...
                    <?php else: ?>
                        <!-- Jika belum login -->
                        <a href="../../pages/pelanggan/index.php" 
